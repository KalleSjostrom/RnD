...
public:
	...
	// @param to A Vector3 position where the line will }
	...
	// @param to A Vector3 position where the arrow will }
	...
	void sphere(Vector3 center, float radius = 0.2f, Vector4 color = DEFAULT_COLOR, unsigned segments = 20, unsigned parts = 2) {
		if (_Debug.disabled) return;
	...
	// @to A Vector3 position where the capsule will }
	...
	// @to A Vector3 position where the cone will }
