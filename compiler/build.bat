...
set INCLUDES=-I %ENGINE% -I ../ -I ../engine/include/
...
set CC=cl.exe
set FLAGS=-nologo -fp:fast -Gm- -GR- -EHsc -FC -Z7 -GF -WL -Wall -GT
rem set FLAGS=-nologo -fp:fast -Gm- -GR- -EHsc -FC -Ox -GF -WL -Wall -GT -MP
