...
#include "../opencl/cl_errors.cpp"
#include "../opengl/gl_errors.cpp"
...
#include "../generated/reload_data_layout.generated.cpp"
...
EXPORT APP_UPDATE(app_update) {
	...
	if (!am->initialized) {
		...
		am->gui = gui::init(am->persistent_arena, am->transient_arena);
