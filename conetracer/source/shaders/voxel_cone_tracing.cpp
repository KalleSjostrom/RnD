...
static const char *fragment = GLSL(
	...
	vec3 indirectDiffuseLight(){
		...
		// Trace front cone
		acc += w1 * traceDiffuseVoxelCone(C_ORIGIN + CONE_OFFSET * normal, normal);
		...
		acc += w2 * traceDiffuseVoxelCone(C_ORIGIN + CONE_OFFSET * ortho, s1);
		acc += w2 * traceDiffuseVoxelCone(C_ORIGIN - CONE_OFFSET * ortho, s2);
		acc += w2 * traceDiffuseVoxelCone(C_ORIGIN + CONE_OFFSET * ortho2, s3);
		acc += w2 * traceDiffuseVoxelCone(C_ORIGIN - CONE_OFFSET * ortho2, s4);
		...
		acc += w3 * traceDiffuseVoxelCone(C_ORIGIN + CONE_OFFSET * corner, c1);
		acc += w3 * traceDiffuseVoxelCone(C_ORIGIN - CONE_OFFSET * corner, c2);
		acc += w3 * traceDiffuseVoxelCone(C_ORIGIN + CONE_OFFSET * corner2, c3);
		acc += w3 * traceDiffuseVoxelCone(C_ORIGIN - CONE_OFFSET * corner2, c4);
