	...
	*/
	...
	const uint32 EVENTWAIT_INFINITE = (uint32)-1;
	...
	*/
	inline void CreateEvent(EventType *event) {
		EventType e = {PTHREAD_COND_INITIALIZER, PTHREAD_MUTEX_INITIALIZER};
		*event = e;
	}
...
*/
inline int GetNumHardwareThreads() {
	return 8; // std::thread::hardware_concurrency();
}
