...
# clang -dynamiclib -std=c++11 source/fluid.cpp -I../ -o out/fluid.dylib $flags $frameworks
# echo "" > out/__lockfile

if clang $debug $common $local_flags -I../ -dynamiclib -std=c++11 source/fluid.cpp -o out/fluid.dylib $flags $frameworks; then
