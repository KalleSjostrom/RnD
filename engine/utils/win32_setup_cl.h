...
#define GET_CL_FUNCTION(lib, name_capitalized, name) name = (name_capitalized*) GetProcAddress(lib, #name)
#define DECLARE_CL_FUNCTION(name_capitalized, name) static name_capitalized *name
...
DECLARE_CL_FUNCTION(CLGETPROGRAMBUILDINFO, clGetProgramBuildInfo);
...
DECLARE_CL_FUNCTION(CLFINISH, clFinish);
DECLARE_CL_FUNCTION(CLCREATEKERNEL, clCreateKernel);

DECLARE_CL_FUNCTION(CLGETDEVICEINFO, clGetDeviceInfo);
DECLARE_CL_FUNCTION(CLGETDEVICEIDS, clGetDeviceIDs);
DECLARE_CL_FUNCTION(CLCREATECONTEXT, clCreateContext);
...
void setup_cl() {
	...
	GET_CL_FUNCTION(lib, CLRELEASEMEMOBJECT, clReleaseMemObject);
	GET_CL_FUNCTION(lib, CLBUILDPROGRAM, clBuildProgram);
	GET_CL_FUNCTION(lib, CLGETPROGRAMBUILDINFO, clGetProgramBuildInfo);
	...
	GET_CL_FUNCTION(lib, CLFINISH, clFinish);
	GET_CL_FUNCTION(lib, CLCREATEKERNEL, clCreateKernel);

	GET_CL_FUNCTION(lib, CLGETDEVICEINFO, clGetDeviceInfo);
	GET_CL_FUNCTION(lib, CLGETDEVICEIDS, clGetDeviceIDs);
